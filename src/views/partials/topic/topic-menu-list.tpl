...
<li {{{ if archived }}}hidden{{{ end }}}>
	<a component="topic/archive" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2 {{{ if archived }}}hidden{{{ end }}}" role="menuitem"><i class="fa fa-fw fa-thumb-tack text-secondary"></i> [[topic:thread-tools.archive]]</a>
</li>

<li {{{ if !archived }}}hidden{{{ end }}}>
	<a component="topic/unarchive" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2 {{{ if !archived }}}hidden{{{ end }}}" role="menuitem"><i class="fa fa-fw fa-thumb-tack fa-rotate-90 text-secondary"></i> [[topic:thread-tools.unarchive]]</a>
</li>
